...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "duration-200 relative flex h-svh w-[--sidebar-width] flex-col border-r border-sidebar-border bg-sidebar transition-[width] ease-linear",
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "group-data-[collapsible=offcanvas]:translate-x-12 group-data-[collapsible=offcanvas]:opacity-0",
        className
      )}
      {...props}
    />
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:hidden",
        showOnHover &&
          "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[active=true]/menu-button:text-sidebar-accent-foreground peer-hover/menu-button:bg-sidebar-accent [@media(pointer:coarse)]:opacity-100 [@media(hover:none)]:opacity-100 opacity-0 transition-opacity",
        className
      )}
      {...props}
    />
